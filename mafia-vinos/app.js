...
function main(){
  ...
  fetch(SHEET_CSV_URL, { cache: "no-store" })
    ...
    .catch(function(err){
      console.error(err);
      var root = document.getElementById("carta");
      root.innerHTML = '<div class="loading">No se pudo cargar la planilla. (Esto suele pasar en Safari si abrís el archivo como file://). Para que funcione, abrilo desde una URL https (Netlify).</div>';
